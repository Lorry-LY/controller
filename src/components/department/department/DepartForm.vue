<template>
  <div class="content">
    <el-row class="title" style="margin:20px 0;">员工信息表</el-row>
    <el-row type="flex" class="row-bg" justify="space-between" style="margin-bottom:20px;margin-top: 20px;">
      ...
      <el-col :span="2">
        <el-button type="primary" @click="handleCreate" style="margin-right:50px;">添加员工</el-button>
      </el-col>
    ...
    <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange"
      ...
      <el-table-column fixed prop="name" label="员工姓名" width="150" sortable>
      </el-table-column>
