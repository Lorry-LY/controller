  ...
  <div class="content">
    ...
    >
      ...
      <el-submenu index="1" disabled>
        ...
        <el-menu-item index="depart_info">异常项目</el-menu-item>
        <el-menu-item index="depart_info">项目信息</el-menu-item>
      </el-submenu>
      <el-submenu index="2">
        <template slot="title"><i class="el-icon-document"></i>部门管理</template>
        <el-menu-item index="depart_manage">部门列表</el-menu-item>
        <el-menu-item index="depart_info">部门信息</el-menu-item>
      </el-submenu>
      <el-submenu index="3">
      ...
      <el-submenu index="5">
        ...
        <el-menu-item index="send_info">下放通知</el-menu-item>
      </el-submenu>
      <el-submenu index="6">
        <template slot="title"><i class="el-icon-setting"></i>设置</template>
        <el-menu-item index="admin_set">管理员设置</el-menu-item>
        <!-- <el-menu-item index="sendMessage">发送通知</el-menu-item> -->
      </el-submenu>
      <el-submenu index="7">
        <template slot="title"><i class="el-icon-warning"></i>说明</template>
        <el-menu-item index="direction">说明</el-menu-item>
      </el-submenu>
    </el-menu>
  </div>
</template>
